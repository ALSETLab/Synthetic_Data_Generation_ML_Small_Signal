...
def prediction_plotting(X_test, Y_test, Y_pred, model_name, set_name = 'Testing'):
    ...
    fig.suptitle("{} - Ground Truth and Prediction ({} set)".format(model_name, set_name), fontsize = 20, fontname = 'liberation sans')
    ...
    axes[0].set_xlabel("Real Axis", fontsize = 14, fontname = 'liberation sans')
    axes[0].set_ylabel("Imaginary Axis", fontsize = 14, fontname = 'liberation sans')
    axes[0].set_title("Ground Truth (hard-coded label)", fontsize = 16, fontname = 'liberation sans')
    axes[0].legend(["Unstable", "Critical", "Acceptable", "Good", "Satisfactory"], prop = {'family' : 'liberation sans'}) 
    ...
    axes[1].set_xlabel("Real Axis", fontsize = 14, fontname = 'liberation sans')
    axes[1].set_ylabel("Imaginary Axis", fontsize = 14, fontname = 'liberation sans')
    axes[1].set_title("Classification Prediction (predicted label)", fontsize = 16, fontname = 'liberation sans')
    axes[1].legend(["Unstable", "Critical", "Acceptable", "Good", "Satisfactory"], prop = {'family' : 'liberation sans'}) 
    ...
    fig.savefig("Figs/Fig_{}_{}_GroundTruth_Prediction.png".format(model_name, set_name), dpi = 300)